...
public class ReportUtil extends Initialization {
	...
	public static void RenameExtentReport(String browsers) {
		...
		if (browsers.equalsIgnoreCase("Chrome")) {
			File file2 = new File(
					UtilConstants.SYSTEM_USER + "\\Results\\LambdaTest_ChromeExtentResults_" + modifiedDate + ".html");
			...
			File file2 = new File(
					UtilConstants.SYSTEM_USER + "\\Results\\LambdaTest_EdgeExtentResults_" + modifiedDate + ".html");
			if (file1.exists()) {
				file1.renameTo(file2);
			}
		} else {
			File file2 = new File(
					UtilConstants.SYSTEM_USER + "\\Results\\LambdaTest_MacSafariExtentResults_" + modifiedDate + ".html");
			if (file1.exists()) {
				file1.renameTo(file2);
			}
		}
